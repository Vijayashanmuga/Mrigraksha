...
class kaphaPage extends StatelessWidget {
  const kaphaPage({super.key});
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          Padding(
            ...
            child: Center(
              child: Image.asset(
                "assets/food_recommendations/Dogeats.png",
                fit: BoxFit.contain,
              ),
            ),
          ),
          ...
          Container(
            ...
            child: Text(
              '    Dogs with a predominance of Kapha usually have more mass to their body and really love their food! They have excellent stamina, sleep soundly and are loyal, steady and loving. Kaphas are usually calm, lower-maintenance dogs who are good with children and other pets.',
            ...
            items: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(8.0),
                  image: DecorationImage(
                    image: AssetImage('assets/food/4.jpg'),
                    fit: BoxFit.contain,
                  ),
                ),
              ),
