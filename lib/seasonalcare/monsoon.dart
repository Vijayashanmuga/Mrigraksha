...
class monsoon extends StatelessWidget {
  monsoon({Key? key}) : super(key: key);
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'Let your dog smile be your umbrella on a monsoon day',
                  style: TextStyle(
  ...
  Widget _imgBanner() {
    return Container(
      height: 400,
      child: Image(
        image: AssetImage('assets/seasons/monsoon/monsoonmain.png'),
      ),
    );
  }
...
class monsoonPage extends StatelessWidget {
  const monsoonPage({super.key});
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          Padding(
            ...
            child: Center(
              child: Image.asset(
                'assets/seasons/monsoon/monsoonmain.png',
                fit: BoxFit.contain,
              ),
            ),
          ),
          ...
          ClickyButton(
            ...
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: ((context) => monsoonHomePage())));
            },
          ),
        ]
                // body: Column(),
...
class monsoonHomePage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            items: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      image: AssetImage('assets/seasons/monsoon/1.jpg'),
                      // NetworkImage(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(8.0),
                  image: DecorationImage(
                    image: AssetImage('assets/seasons/monsoon/2.jpg'),
                    fit: BoxFit.contain,
                  ),
                ),
              ),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(8.0),
                  image: DecorationImage(
                    image: AssetImage('assets/seasons/monsoon/3.jpg'),
                    fit: BoxFit.contain,
                  ),
                ),
              ),
              Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(8.0),
                  image: DecorationImage(
                    image: AssetImage('assets/seasons/monsoon/4.jpg'),
                    fit: BoxFit.contain,
                  ),
                ),
              ),
              Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(8.0),
                  image: DecorationImage(
                    image: AssetImage('assets/seasons/monsoon/5.jpg'),
                    fit: BoxFit.contain,
                  ),
                ),
              ),
              Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(8.0),
                  image: DecorationImage(
                    image: AssetImage('assets/seasons/monsoon/6.jpg'),
                    fit: BoxFit.contain,
                  ),
                ),
              ),
              Container(
                ...
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(8.0),
                    image: DecorationImage(
                      image: AssetImage('assets/seasons/monsoon/7.jpg'),
                      fit: BoxFit.contain,
                    ),
                    color: Color(0xff7B83D6)),
              ),
              Container(
                margin: EdgeInsets.fromLTRB(20, 20, 20, 20),
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(8.0),
                    image: DecorationImage(
                      image: AssetImage('assets/seasons/monsoon/8.jpg'),
                      fit: BoxFit.contain,
                    ),
                    color: Color(0xff5C98E1)),
              ),
              Container(
                margin: EdgeInsets.fromLTRB(20, 20, 20, 20),
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(8.0),
                    image: DecorationImage(
                      image: AssetImage('assets/seasons/monsoon/9.jpg'),
                      fit: BoxFit.contain,
                    ),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(8.0),
                    image: DecorationImage(
                      image: AssetImage('assets/seasons/monsoon/10.jpg'),
                      fit: BoxFit.contain,
                    ),
                    color: Color(0xff4B8CDC)),
              ),
              Container(
                margin: EdgeInsets.fromLTRB(20, 20, 20, 20),
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(8.0),
                    image: DecorationImage(
                      image: AssetImage('assets/seasons/monsoon/11.jpg'),
                      fit: BoxFit.contain,
                    ),
                    color: Color(0xff7B83D6)),
              ),
              Container(
                ...
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(8.0),
                    image: DecorationImage(
                      image: AssetImage('assets/seasons/monsoon/12.jpg'),
                      fit: BoxFit.contain,
                    ),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(8.0),
                    image: DecorationImage(
                      image: AssetImage('assets/seasons/monsoon/13.jpg'),
                      fit: BoxFit.contain,
                    ),
                    color: Color(0xff7EB8CC)),
              ),
              Container(
                // margin: EdgeInsets.fromLTRB(20, 20, 20, 20),
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(8.0),
                    image: DecorationImage(
                      image: AssetImage('assets/seasons/monsoon/14.jpg'),
                      fit: BoxFit.contain,
                    ),
                    color: Color(0xff7EB8CC)),
              ),
              Container(
                ...
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(8.0),
                    image: DecorationImage(
                      image: AssetImage('assets/seasons/monsoon/15.jpg'),
                      fit: BoxFit.contain,
                    ),
                    color: Color(0xff7EB8CC)),
              ),
              Container(
                ...
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(8.0),
                    image: DecorationImage(
                      image: AssetImage('assets/seasons/monsoon/16.jpg'),
                      fit: BoxFit.contain,
                    ),
                    color: Color(0xff7EB8CC)),
              ),
              Container(
                ...
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(8.0),
                    image: DecorationImage(
                      image: AssetImage('assets/seasons/monsoon/17.jpg'),
                      fit: BoxFit.contain,
                    ),
                    color: Color(0xff7EB8CC)),
              ),
              Container(
                ...
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(8.0),
                    image: DecorationImage(
                      image: AssetImage('assets/seasons/monsoon/18.jpg'),
                      fit: BoxFit.contain,
                    ),
                    color: Color(0xff7EB8CC)),
              ),
