...
class Rainy extends StatelessWidget {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'Let your dog smile be your umbrella on a Rainy day',
                  style: TextStyle(
  ...
  Widget _imgBanner() {
    return Container(
      ...
      width: 600,
      child: Image(
        image: AssetImage('assets/seasons/rainy/7.png'),
      ),
    );
  }
          ...
          ClickyButton(
            ...
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: ((context) => rainyHomePage())));
            },
          ),
        ]
                // body: Column(),
...
class rainyHomePage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            items: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(8.0),
                    image: DecorationImage(
                      image: AssetImage('assets/seasons/rainy/1.jpg'),
                      fit: BoxFit.contain,
                    ),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(8.0),
                    image: DecorationImage(
                      image: AssetImage('assets/seasons/rainy/2.jpg'),
                      fit: BoxFit.contain,
                    ),
                    color: Color(0xffFFEEF4)),
              ),
              Container(
                ...
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(8.0),
                    image: DecorationImage(
                      image: AssetImage('assets/seasons/rainy/3.jpg'),
                      fit: BoxFit.contain,
                    ),
                    color: Color(0xffFFEEF4)),
              ),
              Container(
                ...
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(8.0),
                    image: DecorationImage(
                      image: AssetImage('assets/seasons/rainy/4.jpg'),
                      fit: BoxFit.contain,
                    ),
                    color: Color(0xffFFEEF4)),
              ),
              Container(
                ...
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(8.0),
                    image: DecorationImage(
                      image: AssetImage('assets/seasons/rainy/5.jpg'),
                      fit: BoxFit.contain,
                    ),
                    color: Color(0xffFFEEF4)),
              ),
